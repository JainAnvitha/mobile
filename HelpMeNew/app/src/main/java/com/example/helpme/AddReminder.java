...
public class AddReminder extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener,MedicineReminder.OnFragmentInteractionListener {
    ...
    public void done(View view) {
        ...
        MedicineReminderObject mro= new MedicineReminderObject(getApplicationContext(),count, (Integer) ar.get(3),
