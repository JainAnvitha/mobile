...
public class MedicineReminderList extends ArrayAdapter<String> {
    private List names;
    private String[] desc;
    private Activity context;

    public MedicineReminderList(Activity context, List names, String[] desc) {
        super(context, R.layout.medicine_reminder_list_activity, names);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.medicine_reminder_list_activity, parent, false);
            // get all UI view
        ...
        ColorView generator = ColorView.MATERIAL; // or use DEFAULT
       ...
       color = generator.getRandomColor();
        ...
        DrawView drawable = DrawView.builder()
